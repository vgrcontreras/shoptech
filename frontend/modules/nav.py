...
def navbar():
    ...
    with st.sidebar:
        ...
        st.page_link(
            'pages/customer_profile.py', label='ICP - Ideal Customer Profile'
        )
        st.page_link(
            'pages/top10_sales_products_with_margin_ranking.py',
            label='Produtos Mais Vendidos e Margens',
        )
        st.page_link(
            'pages/revenue_tier_per_customer.py',
            label='Tier de Clientes por Faturamento',
        )
        ...
        st.page_link(
            'pages/sub_category_sales_and_margin.py',
            label='Vendas e Margem por Subcategoria',
        )
